...
{
    Input in(ui->input, this);
    Output out(ui->info, this);
    FileManager f;
    f.set_read_file("user.txt");
    std::string name_user;
    f.read_data_file(name_user);
    f.set_read_file("user_data.txt");
    f.set_save_file("user_data.txt");
    PlayGame game(name_user,in, out, f);
