...
QT_MOC_LITERAL(1, 7, 20), // "emit_expression_show"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "Output\0emit_expression_show\0"
};
...
void Output::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->emit_expression_show(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Output::emit_expression_show)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Output::emit_expression_show()
{
